...
<div class="login-box">
    ...
    <h1>ACTYLIVE<h1>
    <form class="" action="crud/cod_actualizar_actividad.php" method="POST">
    ...
    <input type="date" name="fecha_actividad" placeholder="Ingrese Edad">
    ...
    <br><br>
    <input type="submit" name="actualizar_actividad" value="Actualizar">
</body>
</html>
